export default defineEventHandler(() => {
    return [
        ...
        },
        {
            ...
            from: '2025 FEB',
            to: '2025 NOVIEMBRE',
            description: 'Realicé la migración del sitio web, desarrollado previamente en Angular, hacia Vue.js 3. Durante este proceso, también estoy enfocándome en la mejora de la interfaz y experiencia de usuario (UI/UX). El sistema corresponde a un SGDEA (Sistema de Gestión Documental Electrónica Administrativa), utilizado por diversas entidades del Estado. Este sistema permite la gestión de documentos, incluyendo su creación, edición y eliminación. Además, cuenta con un módulo de firma electrónica que facilita la validación de documentos mediante el uso de certificados digitales.',
            skills: [
                { name: 'Javascript', icon: 'mdi mdi-language-javascript', color: '#F7DF1E' },
                { name: 'PHP', icon: 'mdi mdi-language-php', color: '#777BB4' },
                { name: 'VueJS', icon: 'mdi mdi-vuejs', color: '#4FC08D' },
        ...
        },
        {
            ...
            skills: [
                ...
                { name: 'MySQL', icon: 'mdi mdi-database', color: '#4479A1' },
                { name: 'JWT', icon: 'mdi mdi-shield-key', color: '#000000' },
                { name: 'MercadoPago', icon: 'mdi mdi-handshake-outline', color: '#4479A1' },
                { name: null, icon: 'mdi mdi-api', color: '#000000' },
            ],
        },
        {
